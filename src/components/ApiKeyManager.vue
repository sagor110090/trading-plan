  ...
  <div class="bg-white p-6 rounded-lg shadow-sm border">
    ...
    <div class="mb-6">
      <div class="flex items-center justify-between mb-2">
        <span class="font-medium">DeepSeek API Key</span>
        <span
          class="px-2 py-1 rounded-full text-xs font-medium"
          :class="hasDeepseekKey ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'"
        >
      ...
      <div v-if="error" class="mt-3 p-3 bg-red-100 border border-red-400 text-red-700 rounded-lg">
        <p class="text-sm">{{ error }}</p>
      </div>

      <div v-if="success" class="mt-3 p-3 bg-green-100 border border-green-400 text-green-700 rounded-lg">
    ...
    <div class="bg-blue-50 p-4 rounded-lg">
      <h4 class="font-medium text-blue-900 mb-2">How to get your DeepSeek API key:</h4>
      <ol class="text-sm text-blue-800 space-y-1">
        <li>1. Go to <a href="https://platform.deepseek.com" target="_blank" class="underline">platform.deepseek.com</a></li>
